...
const groups = [
  {
    ...
    num: "01",
    description:
      "Algorithmic thinking, competitive programming, and interview prep.",
  },
  {
    ...
    num: "02",
    description:
      "Deep learning, NLP, computer vision, and real-world AI systems.",
  },
  {
    ...
    num: "03",
    description:
      "React, TypeScript, Node.js, and full-stack modern experiences.",
  },
  {
...
const initiatives = [
  {
    icon: Mic,
    label: "Workshops & Tech Talks",
    desc: "Learn directly from peers and industry",
  },
  {
    icon: Trophy,
    label: "Hackathons & Challenges",
    desc: "Compete, build, and push limits",
  },
  {
    icon: GitBranch,
    label: "Open Source Projects",
    desc: "Ship real things as a team",
  },
  {
    icon: Users,
    ...
    <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 pt-36 pb-28 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              >
                {clubInfo.tagline} — the official developer community of the
              ...
              >
                <Link
                  to="/events"
                  className="btn-primary flex items-center gap-2 transition-transform duration-200 hover:scale-[1.03]"
                >
                  Explore Events <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  to="/members"
                  className="btn-secondary flex items-center gap-2 transition-transform duration-200 hover:scale-[1.03]"
                >
                  Meet the Team
                </Link>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  {initiatives.map((item, i) => (
                    ...
                    >
                      <div
                        className="w-7 h-7 rounded-md flex items-center justify-center shrink-0 transition-all duration-200 group-hover:scale-110"
                        style={{
                          background: "rgba(226,106,27,0.1)",
                          border: "1px solid rgba(226,106,27,0.15)",
                        }}
                      >
                        <item.icon
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(226,106,27,0.04) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
          ...
          >
            <span
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] font-mono"
              style={{
                background: "rgba(226,106,27,0.1)",
                color: "var(--brand)",
                border: "1px solid rgba(226,106,27,0.18)",
              }}
            >
              <span
          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            >
              {/* Left accent bar */}
              <div
                className="absolute left-0 top-0 bottom-0 w-[3px] rounded-full transition-all duration-500 group-hover:opacity-100 opacity-80"
                style={{
                  background:
                    "linear-gradient(to bottom, var(--brand), rgba(226,106,27,0.2))",
                }}
              />
              ...
              <div className="pl-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                  <span
                    ...
                    style={{ color: "rgba(226,106,27,0.25)" }}
                  >
                    01
                  </span>
                  <div
                    className="h-px flex-1"
                    style={{ background: "rgba(226,106,27,0.15)" }}
                  />
                  <span
                ...
                >
                  "To be the leading technology community at UDST, fostering
                  innovation, creativity, and technical excellence, empowering
                  students to shape the digital future of Qatar and beyond"
                </p>
                <p className="mt-4 text-sm font-mono" style={{ color: 'var(--brand)', opacity: 0.75, letterSpacing: '0.01em' }}>
                  — Syed, Founder of DevNation
                </p>

                {/* Bottom rule */}
                <div
                  className="mt-10 h-px w-16"
                  style={{ background: "rgba(226,106,27,0.3)" }}
                />
              </div>
            </motion.div>
            ...
            <div
              className="hidden lg:block absolute left-1/2 top-24 bottom-0 w-px"
              style={{ background: "var(--border-subtle)" }}
            />
            ...
            >
              {/* Mobile top border */}
              <div
                className="lg:hidden h-px mb-16"
                style={{ background: "var(--border-subtle)" }}
              />

              {/* Left accent bar */}
              <div
                className="absolute left-0 top-0 bottom-0 w-[3px] rounded-full opacity-80 transition-opacity duration-500 group-hover:opacity-100"
                style={{
                  background:
                    "linear-gradient(to bottom, var(--accent), rgba(176,125,79,0.15))",
                }}
              />
              ...
              <div className="pl-8 lg:pl-16">
                ...
                <div className="flex items-center gap-3 mb-8">
                  <span
                    className="font-mono text-4xl font-black leading-none"
                    style={{ color: "rgba(176,125,79,0.25)" }}
                  >
                    02
                  </span>
                  <div
                ...
                <div
                  className="mt-10 h-px w-16"
                  style={{ background: "rgba(176,125,79,0.3)" }}
                />
              </div>
            </motion.div>
          </div>
            ...
            {groups.map((g, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at 0% 100%, ${g.accent}0a 0%, transparent 60%)`,
                  }}
                />
                {/* Top accent line */}
                <div
                ...
                <div className="flex items-start justify-between mb-8">
                  ...
                  <span
                    className="font-mono text-3xl font-black select-none"
                ...
                <div
                  className="mb-1.5 text-[10px] font-bold uppercase tracking-[0.2em] font-mono"
        ...
        >
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
            <div className="flex items-end justify-between mb-16">
              ...
              <Link
                to="/events"
                className="flex items-center gap-1.5 font-medium text-sm transition-all duration-200 group"
                style={{ color: "var(--brand)" }}
                onMouseEnter={(e) => {
                ...
                <motion.div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 8px 24px rgba(226,106,27,0.08)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = "var(--border-subtle)";
                    e.currentTarget.style.boxShadow = "none";
                  ...
                  <div className="p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <span
                        ...
                        style={{
                          background: "rgba(226,106,27,0.08)",
                          color: "var(--brand)",
                        }}
                      >
                        {event.category}
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8 lg:px-10 text-center">
          ...
          >
            <p
              className="text-[10px] font-bold uppercase tracking-[0.3em] mb-8 font-mono"
              style={{ color: "var(--text-muted)" }}
            >
              Join Us
            </p>
            <h2
              className="text-4xl sm:text-5xl font-display font-bold mb-6 leading-tight"
              style={{ color: "var(--text-primary)", letterSpacing: "-0.04em" }}
            >
              Become Part of
              <br />
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Whether you're just starting or already shipping products —
              there's a group for you. Build, learn, connect.
            </p>
